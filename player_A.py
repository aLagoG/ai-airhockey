    ...
    def next_move(self, current_state):
        ...
        if pt_in_roi:
            ...
            if target_pos != self.my_paddle_pos:
                ...
                direction_vector = {
                    k: v * movement_dist for k, v in direction_vector.items()
                }
                new_paddle_pos = {
                ...
                if (
                    utils.is_inside_goal_area_paddle(new_paddle_pos, current_state)
                    is False
                    and utils.is_out_of_boundaries_paddle(new_paddle_pos, current_state)
                    is None
                ):
